...
# 🎮 Entropy — Community Edition

**Standalone offline build of the sci-fi survival sandbox.**
...
Entropy is a science-fiction survival sandbox set on procedurally generated alien worlds. Players gather resources, craft equipment, construct pressurized habitats, and manage life-support systems against hostile weather and environmental hazards. This Community Edition is a standalone, self-contained package that includes all content and runs fully offline with no storefront required.

This build is for players who want a fully self-contained, offline release of Entropy's survival sandbox with all content included.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3940340/7c5f95b3371a1de395a514d67a1eae8f22ef9180/ss_7c5f95b3371a1de395a514d67a1eae8f22ef9180.1920x1080.jpg?t=1787064929" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3940340/6ff0769095aa8a39e18b0bc67d1e8979a29cb9b2/ss_6ff0769095aa8a39e18b0bc67d1e8979a29cb9b2.1920x1080.jpg?t=1787064929" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3940340/1cf21407e59eb9284e4e9dcdf11fdc18f44e3da6/ss_1cf21407e59eb9284e4e9dcdf11fdc18f44e3da6.1920x1080.jpg?t=1787064929" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, German, French, Spanish, Russian, Simplified Chinese, Japanese, Portuguese-Brazil
- **Voiceover:** English
...
- 🌍 **Procedural Worlds** — Explore alien planets generated from unique seeds with varied biomes.
- 🛠️ **Crafting System** — Build tools, weapons, and gear from gathered raw materials.
- 🏗️ **Base Building** — Construct habitats with power grids, oxygen, and life-support management.
- 🌦️ **Dynamic Hazards** — Storms, radiation zones, and temperature cycles shape each survival run.
- 🎮 **LAN Multiplayer** — LAN or direct connection supported for cooperative survival sessions.
- ⚙️ **Mod Support** — Load community mods and custom world seeds with no additional software required.
- 📦 **Self-Contained Package** — Includes all content and runs offline after installation.
- 🚀 **Instant Setup** — Ready to play immediately, no storefront required.

- **Compression:** Lossless
- **Install Time:** ~5 minutes on SSD, ~12 minutes on HDD
- **Recoding:** none
- **Selective Download:** Optional language packs and bonus content may be skipped during installation.

---

## 📦 DLCs Included

- Entropy: Desert Zones
- Entropy: Orbital Support Pack
- Entropy: Original Soundtrack
...
| **Processor** | Intel Core i5-2400 or AMD FX-6300 | Intel Core i7-7700 or AMD Ryzen 5 3600 |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 660 or AMD Radeon R7 370, 2 GB VRAM | NVIDIA GeForce GTX 1060 or AMD Radeon RX 580, 6 GB VRAM |
| **Storage** | 10 GB available space | 14 GB available space on SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 12 compatible audio hardware and up-to-date GPU drivers |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Entropy\Saved`
